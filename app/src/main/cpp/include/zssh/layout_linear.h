// Автоматическая генерация кода для макета
	...
	grp01->attach(new zViewButton(styles_z_zviewbutton2, z.R.id.button1, z.R.string.press_me, z.R.integer.iconCancel), 
			VIEW_MATCH, VIEW_WRAP);
	grp01->attach(new zViewSwitch(styles_z_zviewswitch1, z.R.id.switch1, z.R.string.mode_already), 
			VIEW_MATCH, VIEW_WRAP);
	...
	grp01->attach(new zViewSwitch(styles_z_switch3, z.R.id.switch3, z.R.string.activate), 
			VIEW_MATCH, VIEW_WRAP);
	grp01->attach(new zViewButton(styles_z_button2, z.R.id.button3, z.R.string.press_me, z.R.integer.iconCancel), 
			VIEW_MATCH, VIEW_WRAP);
	...
	grp01->attach(new zViewSlider(styles_z_seek2, z.R.id.seek2, 0, szi(0, 70), 30, false), 
			VIEW_MATCH, VIEW_WRAP);
	grp01->attach(new zViewButton(styles_z_button2, z.R.id.button4, z.R.string.press_me, z.R.integer.iconCancel), 
			VIEW_MATCH, VIEW_WRAP);
