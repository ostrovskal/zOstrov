// Автоматическая генерация кода для макета
	...
	auto grp21((zLinearLayout*)grp10->attach(new zLinearLayout(styles_z_zlinearlayout1, 0, false), 
			VIEW_MATCH, VIEW_WRAP)); 
	grp21->attach(new zViewRadio(styles_z_radiobutton, z.R.id.radioDark, z.R.string.Temnaja, 1), 
			0, 1, VIEW_WRAP, VIEW_MATCH);
	grp21->attach(new zViewRadio(styles_z_radiolight, z.R.id.radioLight, z.R.string.Svetlaja, 1), 
			0, 1, VIEW_WRAP, VIEW_MATCH);
	...
	grp10->attach(new zViewSwitch(styles_z_zviewswitch1, z.R.id.switch1, z.R.string.Regzim_gotovnosti), 
			VIEW_MATCH, VIEW_WRAP);
	grp10->attach(new zViewButton(styles_z_zviewbutton1, z.R.id.button2, z.R.string.Nagzmi_na_menja__, z.R.integer.iconCancel), 
			VIEW_MATCH, VIEW_WRAP);
	...
	grp10->attach(new zViewSwitch(styles_z_switch3, z.R.id.switch3, z.R.string.Aktivacija), 
			VIEW_MATCH, VIEW_WRAP);
	grp10->attach(new zViewButton(styles_z_zviewbutton1, z.R.id.button3, z.R.string.Nagzmi_na_menja__, z.R.integer.iconCancel), 
			VIEW_MATCH, VIEW_WRAP);
