...
enum ViewStyles {
    ...
    Z_FOREGROUND_PADDING		= (25 | ZTT_INT | ZTT_THM),
    Z_FOREGROUND_TILES			= (26 | ZTT_INT | ZTT_THM),
    Z_FOREGROUND_GRAVITY        = (27 | ZTT_INT),
    Z_FOREGROUND_SCALE          = (28 | ZTT_FLT | ZTT_THM),
    // селектор
    Z_SELECTOR					= (29 | ZTT_INT | ZTT_THM),
    Z_SELECTOR_COLOR			= (30 | ZTT_INT | ZTT_THM),
    Z_SELECTOR_PADDING			= (31 | ZTT_INT | ZTT_THM),
    Z_SELECTOR_TILES			= (32 | ZTT_INT | ZTT_THM),
    // разделитель
    Z_DIVIDER					= (33 | ZTT_INT | ZTT_THM),
    Z_DIVIDER_COLOR				= (34 | ZTT_INT | ZTT_THM),
    Z_DIVIDER_PADDING			= (35 | ZTT_INT | ZTT_THM),
    Z_DIVIDER_TILES				= (36 | ZTT_INT | ZTT_THM),
    Z_DIVIDER_SIZE				= (37 | ZTT_VEC | ZTT_THM),
    Z_DIVIDER_TYPE				= (38 | ZTT_INT | ZTT_THM),
    // маска
    Z_MASK                      = (39 | ZTT_INT | ZTT_THM),
    Z_MASK_COLOR                = (40 | ZTT_INT | ZTT_THM),
    Z_MASK_PADDING              = (41 | ZTT_INT | ZTT_THM),
    Z_MASK_TILES                = (42 | ZTT_INT | ZTT_THM),
    Z_MASK_GRAVITY				= (43 | ZTT_INT),
    // иконка
    Z_ICON    					= (44 | ZTT_INT | ZTT_THM),
    Z_ICON_COLOR				= (45 | ZTT_INT | ZTT_THM),
    Z_ICON_PADDING              = (46 | ZTT_INT | ZTT_THM),
    Z_ICON_TILES                = (47 | ZTT_INT | ZTT_THM),
    Z_ICON_GRAVITY				= (48 | ZTT_INT),
    Z_ICON_SCALE				= (49 | ZTT_FLT | ZTT_THM),
    // прокрутка
    Z_SCROLLBAR     			= (50 | ZTT_INT | ZTT_THM),
    Z_IPADDING                  = (51 | ZTT_VEC),
    Z_FBO                       = (52 | ZTT_INT),
    Z_SCROLLBAR_TILES			= (53 | ZTT_INT | ZTT_THM),
    Z_SCROLLBAR_SIZE			= (54 | ZTT_DMN | ZTT_THM),
    Z_SCROLLBAR_FADE			= (55 | ZTT_INT | ZTT_THM),
    // текст
    Z_TEXT_FONT				    = (56 | ZTT_INT | ZTT_THM),
...
enum ThemeStyles {
    ...
    Z_THEME_SIZE_TEXT_TEXT 		    = (157 | ZTT_INT)
};
